...
// Function:           ViewMonth 
//
// Description:       This function will calculate the time this month for all the projects. 
//
func ViewMonth() {
...
// Function:           ViewWeek 
//
// Description:       This function will calculate the time this week for all the projects. 
//
// Inputs:
...
//
// Function:           GetCommandLineProject 
//
// Description:       This function is used to get the project name from the command line. 
//
// Inputs:
// 		variable 	description
//
func GetCommandLineProject() string {
	//
	// See if we have any input other then the command. 
	//
	proj := ""
	if(len(os.Args) > 2) {
		proj = strings.TrimSpace(os.Args[2])
	}
